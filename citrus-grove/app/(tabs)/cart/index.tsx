...
export default function CartScreen() {
  ...
  function applyPromo() {
    ...
    if (VALID_PROMOS[code]) {
      ...
      setPromoError('Invalid promo code. Try CITRUS10, GROVE15, or NEWUSER.');
      setPromoDiscount(0);
      setPromoApplied('');
    }
  }
  ...
  async function checkout() {
    ...
    setPlacing(true);
    try {
      const code = `CTG-${Math.random().toString(36).toUpperCase().slice(2, 7)}`;
      ...
      Alert.alert(
        'Order Placed',
        `Confirmation: ${code}\n\n+${ptsEarned} Grove Points earned${newBalance != null ? ` — balance: ${Number(newBalance).toLocaleString()} pts` : ''}.\n\nReady in ~15 min at ${store.address}, ${store.city}.\nBring valid 19+ ID.`,
    ...
    return (
      <SafeAreaView style={styles.safe} edges={['top']}>
        ...
        <View style={styles.empty}>
          ...
          <Text style={styles.emptyText}>Browse the grove to fill your basket.</Text>
          <TouchableOpacity
          ...
          >
            ...
            <Text style={styles.browseBtnText}>Browse the Grove</Text>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
    );
    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      >
        <View style={styles.promoBanner}>
          <Ionicons name="sunny" size={20} color={theme.colors.accentDark} />
          <Text style={styles.promoBannerText}>Sunshine savings — try CITRUS10</Text>
        </View>
        ...
        <View style={styles.pickupCard}>
          ...
          <View style={styles.pickupInfo}>
            <Text style={styles.pickupTitle}>Citrus Grove</Text>
          ...
          {promoApplied === '' ? (
            <View style={styles.promoInputRow}>
              <TextInput
                ...
                placeholder="Enter code (e.g. CITRUS10)"
...
const styles = StyleSheet.create({
  ...
  summaryRowBorder: {
    ...
    alignItems: 'center',
    borderTopWidth: 1,
    borderTopColor: theme.colors.onPrimaryMuted,
