...
export default function AIAssistantSheet() {
  ...
  function headerTitle() {
    if (uiStep === 'results') return 'Grove Picks for You';
      ...
      <View style={styles.sheet}>
        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            ...
            <View>
              ...
              <Text style={styles.headerSub}>Your sunny ritual companion</Text>
            </View>
          </View>
        ...
        {uiStep === 'loading' && (
          <View style={styles.loadingWrap}>
            ...
            <Text style={styles.loadingText}>Grove Guide is matching picks</Text>
          </View>
        )}
