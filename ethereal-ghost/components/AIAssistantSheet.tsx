  ...
  function headerLeft() {
    ...
    return (
      <View style={styles.aiBadge}>
        <Ionicons name="wine" size={14} color={theme.colors.gold} />
      </View>
    );
  }
      ...
      <View style={styles.sheet}>
        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            ...
            <View>
              ...
              <Text style={styles.headerSub}>Your Ghost Atelier Sommelier</Text>
            </View>
          </View>
        ...
        {uiStep === 'loading' && (
          <View style={styles.loadingWrap}>
            ...
            <Text style={styles.loadingText}>Your Sommelier is pairing selections</Text>
          </View>
        )}
            ...
            {blurb ? (
              ...
              <View style={styles.blurbCard}>
                <Text style={styles.blurbText}>
                  Based on your answers, here are our top picks for you. Tap a card for full details.
                </Text>
              </View>
            )}
