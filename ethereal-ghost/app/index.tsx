...
const AGE_KEY = '@ghost_atelier_age_verified';
...
export default function SplashScreen() {
  ...
  return (
    <LinearGradient
      colors={[theme.colors.background, theme.colors.backgroundLight, '#0a0a0a']}
      start={{ x: 0, y: 0 }}
      end={{ x: 1, y: 1 }}
    ...
    >
      <View style={styles.logoWrap}>
        ...
        <Text style={styles.brand}>Ghost Atelier</Text>
        <Text style={styles.brandSub}>D I S P E N S A R Y</Text>
      </View>

      <Text style={styles.tagline}>Floating in the void of pure taste.</Text>
