...
export default function CartScreen() {
  ...
  function applyPromo() {
    ...
    if (VALID_PROMOS[code]) {
      ...
      setPromoError('Invalid promo code. Try AMBER10, RESERVE15, or NEWUSER.');
      setPromoDiscount(0);
      setPromoApplied('');
    }
  }
  ...
  async function checkout() {
    ...
    setPlacing(true);
    try {
      const code = `AMB-${Math.random().toString(36).toUpperCase().slice(2, 7)}`;
      ...
      Alert.alert(
        'Order Placed',
        `Confirmation: ${code}\n\n+${ptsEarned} Reserve Points earned${newBalance != null ? ` — balance: ${Number(newBalance).toLocaleString()} pts` : ''}.\n\nReady in ~15 min at ${store.address}, ${store.city}.\nBring valid 19+ ID.`,
      ...
      <SafeAreaView style={styles.safe} edges={['top']}>
        ...
        <View style={styles.empty}>
          ...
          >
            ...
            <Text style={styles.browseBtnText}>Browse the Humidor</Text>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
    );
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      >
        ...
        <View style={styles.pickupCard}>
          ...
          <View style={styles.pickupInfo}>
            <Text style={styles.pickupTitle}>Amber Reserve</Text>
          ...
          {promoApplied === '' ? (
            <View style={styles.promoInputRow}>
              <TextInput
                ...
                placeholder="Enter code (e.g. AMBER10)"
      ...
      {/* Floating checkout dock — total always visible above tab bar */}
      <View style={styles.dock}>
        <View style={styles.dockTotalBlock}>
          <Text style={styles.dockTotalLabel}>Total</Text>
          <Text style={styles.dockTotalValue}>${total.toFixed(2)}</Text>
        </View>
        <TouchableOpacity
          style={[styles.dockBtn, placing && { opacity: 0.7 }]}
          onPress={checkout}
          activeOpacity={0.9}
          disabled={placing}
        >
          {placing ? (
            ...
            <>
              <Text style={styles.dockBtnText}>Checkout</Text>
