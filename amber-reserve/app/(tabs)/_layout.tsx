...
/**
 * Amber Reserve lounge tab bar — mahogany capsule with soft 8px corners
 * (not a full pill) and amber/gold active highlight.
 */
function LoungeTabBar({ state, navigation }: TabBarProps) {
...
export default function TabLayout() {
  return (
    <Tabs
      ...
      tabBar={(props) => <LoungeTabBar {...props} />}
    >
