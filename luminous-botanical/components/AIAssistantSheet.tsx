...
export default function AIAssistantSheet() {
  ...
  function headerTitle() {
    if (uiStep === 'results') return 'Your Botanical Picks';
    if (uiStep === 'detail') return detailProduct?.name ?? 'Product Detail';
    return 'Midnight AI Sommelier';
  }
        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            ...
            <View>
              ...
              <Text style={styles.headerSub}>Your personalized botanical guide</Text>
            </View>
          </View>
            ...
            {blurb ? (
              ...
              <View style={styles.blurbCard}>
                <Text style={styles.blurbText}>
                  Based on your answers, here is a personalized botanical guide. Tap a pick for full details.
                </Text>
              </View>
            )}
