      ...
      >
        ...
        <View style={styles.heroWrap}>
          <LinearGradient
            ...
            style={styles.hero}
          >
            <Text style={styles.heroEyebrow}>AFTER DARK COLLECTION</Text>
            <Text style={styles.heroTitle}>A dimly lit lounge for curated tastes.</Text>
            <Text style={styles.heroSub}>
              Crimson silk, rose-gold foil, and strains for the night.
            </Text>
            <TouchableOpacity
        ...
        <TouchableOpacity style={styles.pickupCard} activeOpacity={0.85} onPress={() => setShowStoreSheet(true)}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.pickupLabel}>PICKUP LOUNGE</Text>
