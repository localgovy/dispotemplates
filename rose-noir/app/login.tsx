  ...
  return (
    ...
    >
      ...
      <View style={styles.logoWrap}>
        ...
        <Text style={styles.brand}>Rose Noir</Text>
        <Text style={styles.brandSub}>D I S P E N S A R Y</Text>
      </View>

      <Text style={styles.tagline}>A dimly lit lounge for curated tastes.</Text>
      ...
      <View style={styles.card}>
        ...
        >
          {loading ? (
            ...
            <Ionicons name="logo-google" size={20} color={theme.colors.primaryDark} />
          )}
