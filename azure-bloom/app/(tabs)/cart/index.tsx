...
export default function CartScreen() {
  ...
  function applyPromo() {
    ...
    if (VALID_PROMOS[code]) {
      ...
      setPromoError('Invalid promo code. Try AZURE10, BLOOM15, or NEWUSER.');
      setPromoDiscount(0);
      setPromoApplied('');
    }
  }
  ...
  async function checkout() {
    ...
    setPlacing(true);
    try {
      const code = `AZB-${Math.random().toString(36).toUpperCase().slice(2, 7)}`;
      ...
      Alert.alert(
        'Order Placed',
        `Confirmation: ${code}\n\n+${ptsEarned} Bloom Points earned${newBalance != null ? ` — balance: ${Number(newBalance).toLocaleString()} pts` : ''}.\n\nReady in ~15 min at ${store.address}, ${store.city}.\nBring valid 19+ ID.`,
      ...
      <SafeAreaView style={styles.safe} edges={['top']}>
        ...
        <View style={styles.empty}>
          ...
          >
            ...
            <Text style={styles.browseBtnText}>Browse Blooms</Text>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
    );
      ...
      >
        ...
        <View style={styles.pickupCard}>
          ...
          <View style={styles.pickupInfo}>
            <Text style={styles.pickupTitle}>Azure Bloom</Text>
          ...
          {promoApplied === '' ? (
            <View style={styles.promoInputRow}>
              <TextInput
                ...
                placeholder="Enter code (e.g. AZURE10)"
        ...
        <View style={styles.summaryCard}>
          ...
          {promoDiscount > 0 && (
            <View style={styles.summaryRow}>
              <Text style={[styles.summaryLabel, { color: theme.colors.info }]}>
                Promo ({promoApplied})
              </Text>
