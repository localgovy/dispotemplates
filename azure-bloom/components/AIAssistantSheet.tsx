...
export default function AIAssistantSheet() {
  ...
  function headerTitle() {
    if (uiStep === 'results') return 'Your Ritual Picks';
      ...
      <View style={styles.sheet}>
        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            ...
            <View>
              ...
              <Text style={styles.headerSub}>Your airy ritual guide</Text>
            </View>
          </View>
        ...
        {uiStep === 'loading' && (
          <View style={styles.loadingWrap}>
            ...
            <Text style={styles.loadingText}>Azure Bloom is matching picks</Text>
          </View>
        )}
