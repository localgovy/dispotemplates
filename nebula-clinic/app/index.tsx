...
const AGE_KEY = '@nebula_clinic_age_verified';
  ...
  return (
    ...
    >
      <View style={styles.logoWrap}>
        ...
        <Text style={styles.brand}>Nebula Clinic</Text>
        <Text style={styles.brandSub}>D I S P E N S A R Y</Text>
      </View>

      <Text style={styles.tagline}>Ancestral wisdom for modern rituals.</Text>
...
const styles = StyleSheet.create({
  ...
  gateOverlay: {
    flex: 1,
    backgroundColor: 'rgba(6, 22, 12, 0.92)',
    alignItems: 'center',
    justifyContent: 'center',
