        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            ...
            <View>
              ...
              <Text style={styles.headerSub}>AI CORE ACTIVE</Text>
            </View>
          </View>
            ...
            <View style={styles.pkCard}>
              ...
              <View style={styles.pkRow}>
                <View style={styles.pkCell}>
                  ...
                  <Text style={styles.pkValue}>15–25 min</Text>
                </View>
                <View style={styles.pkDivider} />
                <View style={styles.pkCell}>
                  <Text style={styles.pkLabel}>Peak</Text>
                  <Text style={styles.pkValue}>~45 min</Text>
                </View>
                <View style={styles.pkDivider} />
                <View style={styles.pkCell}>
